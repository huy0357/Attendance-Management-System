...
class EmployeeScheduleServiceTest {
        ...
        void assignRangeThrowsWhenShiftDoesNotExist() {
                ...
                RuntimeException ex = assertThrows(RuntimeException.class,
                                () -> employeeScheduleService.assignRange(request));
        ...
        void assignRangeCreatesSchedulesAcrossDateRangeWhenNoConflict() {
                ...
                when(scheduleRepo.findByEmployeeIdAndWorkDateBetween(1L, LocalDate.of(2026, 3, 17),
                                LocalDate.of(2026, 3, 20)))
                                .thenReturn(List.of());
                when(scheduleRepo.save(any(EmployeeSchedule.class)))
