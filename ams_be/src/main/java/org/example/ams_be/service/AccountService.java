...
public class AccountService {
    ...
    private final AuditLogService auditLogService; // 1. Tiêm AuditLogService
    ...
    public AccountResponse createAccount(CreateAccountRequest req) {
        ...
        auditLogService.saveAuditLog("CREATE", "ACCOUNT", saved.getAccountId(),
    ...
    public AccountDto update(Long id, UpdateAccountRequest req) {
        ...
        auditLogService.saveAuditLog("UPDATE", "ACCOUNT", id,
    ...
    public void delete(Long id) {
        ...
        auditLogService.saveAuditLog("DELETE", "ACCOUNT", id,
    ...
    public PageResponse<AccountDto> getAccountsPage(PageRequestDto req, Boolean isActive) {
        ...
        Page<Account> pageData = (isActive == null) ? accountRepository.findAll(pageable)
                : accountRepository.findAllByIsActive(isActive, pageable);
        return new PageResponse<>(pageData.getContent().stream().map(this::toDto).toList(), page, size,
